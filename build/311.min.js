        ...
        link: function($scope, $elem, ctrl) {
            function addComplaintMarker(complaint) {
                ...
                google.maps.event.addListener(marker, "click", function() {
                    infowindow.setContent(complaint.getDisplayHtml()), infowindow.open(map, marker);
                }), markers.push(marker);
            }
            var initialLocation = new google.maps.LatLng(47.6101, -122.342), mapOptions = {
                zoom: 15,
                center: initialLocation
            }, map = new google.maps.Map(document.getElementById("map-canvas"), mapOptions), infowindow = new google.maps.InfoWindow();
    ...
    var ComplaintFactory = function() {
        var Complaint = function() {
            ...
            return function(data) {
                ...
                this.street_name = data.street_name, this.getDisplayHtml = function() {
                    var str = "";
                    ...
                    str += formatHtml("Description: ", this.descriptor), str += formatHtml("Resolution: ", this.resolution_description);
                };
            };
        }();
        return Complaint;
